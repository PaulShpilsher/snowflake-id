...
const encodeMap = "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ"
...
func Encode(n int64) (string, error) {
	if n < 58 {
		...
		return string(encodeMap[n]), nil
	}

	buf := make([]byte, 0, 11)
	for n >= 58 {
		buf = append(buf, encodeMap[n%58])
		n /= 58
	}
	buf = append(buf, encodeMap[n])
...
////////////////////////////////////////////////////////////////
// Decoding base58 sting to int64
////////////////////////////////////////////////////////////////
